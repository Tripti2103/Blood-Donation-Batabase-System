...
con = pymysql.connect(host='localhost', user='root', password='1234#')  # userentry.get()
mycursor = con.cursor()
query = 'use bloodbank'
...
rightFrame.place(x=260,y=80,width=1000,height=300)

scrollBarX=Scrollbar(rightFrame,orient=HORIZONTAL)
scrollBarY=Scrollbar(rightFrame,orient=VERTICAL)

rightFramedown=Frame(window1,bg='')
rightFramedown.place(x=260,y=400,width=1000,height=300)
